/*
  ...
  - You are about to drop the column `med_administration_id` on the `medadministration` table. All the data in the column will be lost.
...
ALTER TABLE `medadministration` DROP PRIMARY KEY,
    DROP COLUMN `med_administration_id`,
    MODIFY `consultation_id` INTEGER NOT NULL AUTO_INCREMENT,
