/*
  ...
  - Added the required column `unit` to the `equipment` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `equipment` ADD COLUMN `unit` VARCHAR(225) NOT NULL;
