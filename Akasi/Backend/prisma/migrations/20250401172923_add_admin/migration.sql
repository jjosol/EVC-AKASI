...
-- AlterTable
ALTER TABLE `editsequipment` ADD COLUMN `admin_id` INTEGER NULL;

-- AlterTable
ALTER TABLE `editsinverntory` ADD COLUMN `admin_id` INTEGER NULL;

-- CreateIndex
CREATE INDEX `EditsEquipment_admin_id_idx` ON `EditsEquipment`(`admin_id`);

-- CreateIndex
CREATE INDEX `EditsInverntory_admin_id_idx` ON `EditsInverntory`(`admin_id`);
...
-- RenameIndex
ALTER TABLE `editsinverntory` RENAME INDEX `FK_inventory_TO_EditsInverntory` TO `EditsInverntory_med_id_medName_idx`;
