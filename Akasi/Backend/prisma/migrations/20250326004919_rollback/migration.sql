...
-- AlterTable
ALTER TABLE `client` ADD COLUMN `status` VARCHAR(191) NOT NULL DEFAULT 'pending';

-- AlterTable
ALTER TABLE `dental_certificates` ADD COLUMN `notes` VARCHAR(500) NULL,
    ADD COLUMN `status` VARCHAR(191) NOT NULL DEFAULT 'pending',
    MODIFY `dental` LONGBLOB NOT NULL;

-- AlterTable
ALTER TABLE `medical_certificates` ADD COLUMN `notes` VARCHAR(500) NULL,
    ADD COLUMN `status` VARCHAR(191) NOT NULL DEFAULT 'pending',
    MODIFY `medical` LONGBLOB NOT NULL;

-- AlterTable
ALTER TABLE `opthal_certificates` ADD COLUMN `notes` VARCHAR(500) NULL,
    ADD COLUMN `status` VARCHAR(191) NOT NULL DEFAULT 'pending',
    MODIFY `opthal` LONGBLOB NOT NULL;

-- AlterTable
ALTER TABLE `physical_exam` ADD COLUMN `notes` VARCHAR(500) NULL,
    ADD COLUMN `status` VARCHAR(191) NOT NULL DEFAULT 'pending',
