/*
  ...
  - Added the required column `fatalityprisma` to the `consultation_records` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `client` ADD COLUMN `type` VARCHAR(225) NOT NULL DEFAULT 'N/A';

-- AlterTable
ALTER TABLE `consultation_records` ADD COLUMN `fatalityprisma` BOOLEAN NOT NULL;
