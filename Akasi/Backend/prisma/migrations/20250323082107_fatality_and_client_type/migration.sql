/*
  ...
  - You are about to drop the column `fatalityprisma` on the `consultation_records` table. All the data in the column will be lost.
  - Added the required column `fatality` to the `consultation_records` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE `consultation_records` DROP COLUMN `fatalityprisma`,
    ADD COLUMN `fatality` BOOLEAN NOT NULL;
