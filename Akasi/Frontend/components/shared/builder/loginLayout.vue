...
<template>
  <div class="font-inter relative min-h-screen flex overflow-hidden">
    ...
    <div class="ml-auto relative bg-[#f8f4ff] w-full md:w-5/12 h-screen flex flex-col">
      ...
      <!-- Logo Section -->
      <div class="px-12">
        <AkasiLogin class="text-6xl md:text-7xl mb-8" />
        ...
        <div class="space-y-6">
          ...
          <!-- Error Message -->
          <div v-if="loginError" class="rounded-lg bg-red-50 p-4 text-sm text-red-700 border-l-4 border-red-500 animate-fadeIn">
