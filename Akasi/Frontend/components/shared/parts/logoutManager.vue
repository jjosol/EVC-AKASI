<template>
    <div>
        <button
            ...
            class="w-56 px-5 py-3 text-lg font-medium flex items-center justify-center rounded-full transition-all duration-200 ease-in-out bg-[#745dab] text-[#f8f4ff] hover:bg-[#f8f4ff] hover:text-[#745dab] shadow-md"
            :disabled="isLoading"
        >
            <Icon 
                v-if="isLoading" 
