...
__export(index_exports, {
  ...
  download: () => import_chunk_CH3BHOUG.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_CH3BHOUG.getBinaryName,
  getCacheDir: () => import_chunk_G7EM4XDM.getCacheDir,
  getProxyAgent: () => import_chunk_AGZFDFHU.getProxyAgent,
  getVersion: () => import_chunk_CH3BHOUG.getVersion,
  maybeCopyToTmp: () => import_chunk_CH3BHOUG.maybeCopyToTmp,
  overwriteFile: () => import_chunk_G7EM4XDM.overwriteFile,
  plusX: () => import_chunk_CH3BHOUG.plusX,
  vercelPkgPathRegex: () => import_chunk_CH3BHOUG.vercelPkgPathRegex
});
module.exports = __toCommonJS(index_exports);
var import_chunk_CH3BHOUG = require("./chunk-CH3BHOUG.js");
